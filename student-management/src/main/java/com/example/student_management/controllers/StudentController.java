...
@Tag(name = "Student API", description = "API de gestion des étudiants")
public class StudentController {
    ...
    @Operation(summary = "Afficher tous les étudiants (endpoint racine)")
    @GetMapping
    public ResponseEntity<List<Student>> getAllStudentsRoot() {
